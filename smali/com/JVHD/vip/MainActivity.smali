.class public final Lcom/JVHD/vip/MainActivity;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/JVHD/vip/MainActivity$BinChromeClient;,
        Lcom/JVHD/vip/MainActivity$BinWebViewClient;,
        Lcom/JVHD/vip/MainActivity$Companion;,
        Lcom/JVHD/vip/MainActivity$StartupRetryListener;
    }
.end annotation

.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nMainActivity.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MainActivity.kt\ncom/JVHD/vip/MainActivity\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,193:1\n1#2:194\n*E\n"
.end annotation
...
# static fields
.field public static final Companion:Lcom/JVHD/vip/MainActivity$Companion;
...
.method public static synthetic $r8$lambda$FDrxY6QIjCT6Y3k_qp1wEPv-me0(Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/JVHD/vip/MainActivity;->dispatchBackToJs$lambda$1$lambda$0(Ljava/lang/String;)V
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/JVHD/vip/MainActivity$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/JVHD/vip/MainActivity$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/JVHD/vip/MainActivity;->Companion:Lcom/JVHD/vip/MainActivity$Companion;
...
.method private final configureWebView()V
    ...
    .line 83
    iget-object v0, p0, Lcom/JVHD/vip/MainActivity;->webView:Landroid/webkit/WebView;
    ...
    .line 110
    iget-object v4, p0, Lcom/JVHD/vip/MainActivity;->webView:Landroid/webkit/WebView;
...
.method private final dispatchBackToJs()V
    ...
    check-cast v1, Lcom/JVHD/vip/MainActivity;

    .line 172
    iget-object v1, p0, Lcom/JVHD/vip/MainActivity;->webView:Landroid/webkit/WebView;
    ...
    :cond_0
    new-instance v2, Lcom/JVHD/vip/MainActivity$$ExternalSyntheticLambda0;

    invoke-direct {v2}, Lcom/JVHD/vip/MainActivity$$ExternalSyntheticLambda0;-><init>()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/JVHD/vip/MainActivity;->webView:Landroid/webkit/WebView;
    ...
    invoke-virtual {p0, v0}, Lcom/JVHD/vip/MainActivity;->setContentView(Landroid/view/View;)V

    .line 69
    invoke-direct {p0}, Lcom/JVHD/vip/MainActivity;->configureWebView()V
    ...
    :cond_3
    new-instance v1, Lcom/JVHD/vip/TizenBridge;

    move-object v2, p0

    check-cast v2, Landroid/app/Activity;

    invoke-direct {v1, v2}, Lcom/JVHD/vip/TizenBridge;-><init>(Landroid/app/Activity;)V
    ...
    :cond_4
    new-instance v1, Lcom/JVHD/vip/MainActivity$BinWebViewClient;

    invoke-direct {v1, p0}, Lcom/JVHD/vip/MainActivity$BinWebViewClient;-><init>(Lcom/JVHD/vip/MainActivity;)V
    ...
    :cond_5
    new-instance v1, Lcom/JVHD/vip/MainActivity$BinChromeClient;

    invoke-direct {v1, p0}, Lcom/JVHD/vip/MainActivity$BinChromeClient;-><init>(Lcom/JVHD/vip/MainActivity;)V
    ...
    .line 75
    iget-object p1, p0, Lcom/JVHD/vip/MainActivity;->webView:Landroid/webkit/WebView;
    ...
    invoke-direct {p0, p1}, Lcom/JVHD/vip/MainActivity;->showStartupError(Ljava/lang/Throwable;)V

    return-void
.end method

# [JVHD-CRASH] Man hinh loi khoi dong: chi dung View thuan (khong can WebView,
# khong can resource moi). Ghi full stack trace ra logcat tag JVHD-CRASH va ra
# tep jvhd-crash.txt, hien thi duong dan tep len man hinh. KHONG ket luan
# nguyen nhan - stack trace la bang chung duy nhat.
.method private final showStartupError(Ljava/lang/Throwable;)V
    .locals 10

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/JVHD/vip/MainActivity;->startupError:Z

    # Full stack trace -> logcat tag JVHD-CRASH.
    ...
    # Ghi stack trace ra getExternalFilesDir(null)/jvhd-crash.txt
    # (/sdcard/Android/data/com.JVHD.vip/files/jvhd-crash.txt); neu thu muc
    # ngoai khong co thi dung getFilesDir(). Tat ca duoc try/catch: ham nay
    # khong bao gio duoc phep nem exception, va khong bao gio tu dong goi
    # finishAffinity()/System.exit().
    const/4 v6, 0x0
    ...
    :cond_have_dir
    if-nez v4, :cond_write_done

    new-instance v5, Ljava/io/File;

    const-string v2, "jvhd-crash.txt"
    ...
    :try_end_write
    .catch Ljava/lang/Throwable; {:try_start_write .. :try_end_write} :catch_write

    goto :cond_write_done
    ...
    const-string v2, "cannot write jvhd-crash.txt"

    invoke-static {v1, v2, v7}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    :cond_write_done
    # Dong mo ta ngoai le lay thang tu trace (su that, khong phai phong doan).
    const-string v9, "không rõ ngoại lệ"

    if-eqz p1, :cond_have_text
    ...
    const-string v2, "JVHD Vip2 không khởi động được.\n\n"
    ...
    if-eqz v6, :cond_no_path

    const-string v2, "\n\nĐã lưu chi tiết lỗi tại:\n"
    ...
    :cond_no_path
    const-string v2, "\n\n(Không ghi được tệp chi tiết lỗi.)"

    invoke-virtual {v8, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    :cond_path_done
    const-string v2, "\n\nBấm \"Thử lại\" để mở lại ứng dụng."
    ...
    # Nut "Thu lai" -> recreate() Activity de thu khoi dong lai.
    ...
    new-instance v2, Lcom/JVHD/vip/MainActivity$StartupRetryListener;

    invoke-direct {v2, p0}, Lcom/JVHD/vip/MainActivity$StartupRetryListener;-><init>(Lcom/JVHD/vip/MainActivity;)V
...
.method protected onDestroy()V
    ...
    check-cast v0, Lcom/JVHD/vip/MainActivity;
    ...
    iget-object v3, p0, Lcom/JVHD/vip/MainActivity;->webView:Landroid/webkit/WebView;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget-boolean v0, p0, Lcom/JVHD/vip/MainActivity;->startupError:Z
    ...
    .line 163
    :cond_5
    invoke-direct {p0}, Lcom/JVHD/vip/MainActivity;->dispatchBackToJs()V
